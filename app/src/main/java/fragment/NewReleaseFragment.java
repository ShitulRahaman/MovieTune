...
import com.icchastudio.shitul.movietune.MovieTuneMainActivity;
 ...
 */
public class NewReleaseFragment extends Fragment implements MovieGridRecyclerViewAdapter.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.new_release, container, false);
    ...
    private void getVedios() {
        ...
        Call<PageObject> call = service.getNewReleasePageObject(Utility.apiKey, currentPage);
