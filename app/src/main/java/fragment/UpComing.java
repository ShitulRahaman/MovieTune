 ...
 */
public class UpComing extends Fragment implements MovieGridRecyclerViewAdapter.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.up_coming, container, false);
    ...
    private void getVedios() {
        ...
        Call<PageObject> call = service.getUpComingPageObject(Utility.apiKey, currentPage);
